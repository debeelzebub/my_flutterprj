...
import 'package:my_flutterprj/sharedprefencercew/sharelogin.dart';
...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void storedata() async {
    ...
    int phoneno= phno.text as int;
    double times= tim.text as double;

    preferences = await SharedPreferences.getInstance();
    preferences.setString('name', personname);
    preferences.setString('uname', username);
    preferences.setString('pass', password);
    preferences.setInt('phone', phoneno);
    preferences.setDouble('time', times);
